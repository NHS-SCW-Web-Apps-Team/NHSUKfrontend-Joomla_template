...
<div class="nhsuk-form-group control-group<?php echo $class; ?>"<?php echo $rel; ?>>
	<?php if (empty($options['hiddenLabel'])): ?>
		<div class="control-label">
			<?php echo str_replace('class="','class="nhsuk-label ',$label); ?>
	...
	<?php endif; ?>
	<div class="controls">
		<?php echo str_replace('class="','class="nhsuk-input ', $input); ?>
	</div>
</div>
