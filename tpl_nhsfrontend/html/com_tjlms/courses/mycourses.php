 ...
 // Import js
 JHtml::script(JUri::base() . '/administrator/components/com_tjlms/assets/js/tjlms.js', true);
 ...
 <div class="row-fluid tjlms_courses_head ">
 	<div class="tjlms_head_title pull-left">
 		<h3><?php echo JText::_("COM_TJLMS_MY_COURSES")?></h3>
 		</div>
 </div>
 ...
 -->
 					<th width="8%"><?php
 							echo JHTML::tooltip(JText::_('COM_TJLMS_TOTAL_ENROLLED_USERS'), '','', JText::_('COM_TJLMS_TOTAL_ENROLLED_USERS'));
 					?></th>
 ...
 -->
 					...
 					<th width="8%"><?php
 							echo JHTML::tooltip(JText::_('COM_TJLMS_ACCESS_LEVEL'), '','', JText::_('COM_TJLMS_ACCESS_LEVEL'));
 					?></th>
 ...
 -->
 							...
 							<?php //if ($canEdit) : ?>
 <!--
 								<a href="<?php echo JRoute::_('index.php?option=com_tjlms&view=course&id='.(int) $item->id); ?>">
 -->
 					...
 					<?php } ?>
 							...
 							<td>
 								<div class="btn-group">
 									...
 									?>
 									<a title="<?php echo JText::_( 'COM_TJLMS_ENROLL_USER' ); ?> "  onclick="opentjlmsSqueezeBox('<?php echo $enrolment_link; ?>')" class="modal  btn enroll_users <?php echo $InactiveBtn; ?>">
