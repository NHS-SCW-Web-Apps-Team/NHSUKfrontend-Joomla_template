...
<div class="<?php echo COM_TJLMS_WRAPPER_DIV; ?> com_tjlms_content tjBs3 container-fluid">
		...
		<div class="row">
			<div class="col-xs-12">
				...
				<h1><?php echo (!empty($defaultclass))? $pageHeading: $pageHeading . $colon .$active_cat; ?></h1>
			</div>
		</div>
		...
		<?php   } ?>
			...
			<div class="<?php echo $tjlmsCoursesDiv;?> tjlms-courses">
				...
				?>
				<div id="tjlms_pin_container" class="<?php echo $coursesContainerClass;?> ledercourselist">
					<?php
						if (!empty($courses))
						{
