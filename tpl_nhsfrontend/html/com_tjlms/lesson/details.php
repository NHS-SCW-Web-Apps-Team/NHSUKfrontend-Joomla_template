					...
					<div style="padding:15px">
						...
						<div class="media-content">
							...
							if(strlen($this->lesson_data->description) > 75 )
								echo "<h3>".nl2br($this->tjlmshelperObj->html_substr($this->lesson_data->description, 0, 75 )).'<a href="javascript:" class="r-more">' . JText::_("COM_TJLMS_TOC_COURSE_DESC_MORE") . '</a></h3>';
							else
							...
							<?php
								echo "<h3>".nl2br($this->lesson_data->description).'<a href="javascript:" class="r-less">' . JText::_("COM_TJLMS_TOC_COURSE_DESC_LESS") . '</a></h3>';
							?>
							</div>
						</div><!--media-contenta-->
						<div class="pull-right">
							<?php
								...
								{
									$text=JText::_("COM_TJLMS_AVAILABLE");
								...
								else
								{
									...
									{
										$text=JText::_("COM_TJLMS_EXPIRED");
		...
		<div class="lesson_info">
			<table class="table table-bordered">
				<div class="row-fluid lesson_info_details">
					<tr><td>
					<div class="span6 tjlms-bold-text right-border"><?php echo JText::_("COM_TJLMS_FORM_LESSON_NO_OF_ATTEMPTS")?> </div></td>
				...
				<div class="row-fluid lesson_info_details">
					<tr><td>
					<div class="span6 tjlms-bold-text right-border"><?php echo JText::_("COM_TJLMS_FORM_LESSON_ATTEMPTS_GRADE")?>  </div></td>
					<td><div class="span5">
						<?php
						switch($this->lesson_data->attempts_grade)
						{
							case '0':
								echo JText::_("COM_TJLMS_GRADE_HIGHEST_ATTEMPT");
							break;
							case '1':
								echo JText::_("COM_TJLMS_GRADE_AVERAGE_ATTEMPT");
							break;
							case '2':
								echo JText::_("COM_TJLMS_GRADE_FIRST_ATTEMPT");
							break;
							case '3':
								echo JText::_("COM_TJLMS_GRADE_LAST_COMPLETED_ATTEMPT");
							break;
				...
				<div class="row-fluid lesson_info_details">
					<tr><td>
					<div class="span6 tjlms-bold-text right-border"><?php echo JText::_("COM_TJLMS_FORM_LESSON_CONSIDER_MARKS")?> </div></td>
					<td><div class="span5">
						...
						{
							case '0':
								echo JText::_("COM_TJLMS_NO");
							break;
							case '1':
								echo JText::_("COM_TJLMS_YES");
							break;
						}
					...
					<div class="row-fluid lesson_info_details">
						...
						<div class="span6 tjlms-bold-text right-border">
							<?php
									...
									{
										$contentformat=JText::_("TJLMS_LESSON");
									}
									else
									{
										$contentformat=JText::_("TJLMS_".strtoupper($this->lesson_data->format));
									}
									echo JText::sprintf("TJLMS_ELIGIBILITY_CRITERIA",$contentformat);
							?></div></td>
						<td><div class="span5">
				...
				<div class="row-fluid lesson_info_details">
					<tr><td>
					<div class="span6 tjlms-bold-text right-border"><?php echo JText::_('TJLMS_CONTENT_FORMAT');?> </div></td>
					<td><div class="span5">
								<?php echo JText::_("TJLMS_".strtoupper($this->lesson_data->format));?>
					</div></td><tr>
				</div>
				<div class="row-fluid lesson_info_details">
					<tr><td>
					<div class="span6 tjlms-bold-text right-border"><?php echo JText::_('TJLMS_MARKING_PASSING');?></div></td>
					<td><div class="span5">
								<?php
