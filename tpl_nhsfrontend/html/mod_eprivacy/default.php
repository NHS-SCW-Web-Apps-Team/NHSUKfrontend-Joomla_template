...
<div class="plg_system_eprivacy_module">
    ...
    <div class="plg_system_eprivacy_message nhsuk-u-margin-top-4" style="display:none">
        <?php if($params->get('showtitle',1)): ?>
        <h2>Cookies on the LeDeR website</h2>
        <?php endif; ?>
        ...
        <p>Let us know if this is OK. We'll use a cookie to save your choice. You can <a id="nhsuk-cookie-banner__link" href="/cookies" tabindex="1">read more about our cookies</a> before you choose.</p>
    ...
    <div class="plg_system_eprivacy_declined" style="display:none">
        <?php /*
        <p>
            <button class="nhsuk-button plg_system_eprivacy_reconsider"><?php echo JText::_('PLG_SYS_EPRIVACY_RECONSIDER');?></button>
        <?php //echo JText::_('PLG_SYS_EPRIVACY_DECLINED'); ?>
        </p>


        <p>declined - You can change your cookie settings at any time using our <a href="/cookies">cookies page.</a></p>
    ...
    <!--<button class="nhsuk-button plg_system_eprivacy_accepted"><?php echo JText::_('PLG_SYS_EPRIVACY_UNACCEPT');?></button>-->
        ...
        <p>accepted - You can change your cookie settings at any time using our <a href="/cookies">cookies page.</a></p>
        */?>
    </div>
</div>
