...
<div class="system-unpublished">
    ...
    <div class="nhsuk-card nhsuk-card--clickable">
        <?php echo JLayoutHelper::render('joomla.content.card_intro_image', $this->item); ?>
        <div class="nhsuk-card__content">

            <?php echo JLayoutHelper::render('joomla.content.card_style_default_item_title', $this->item); ?>
